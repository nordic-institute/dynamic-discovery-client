...
class OffsetDateAdapterTest {
    ...
    private static final LocalDate TEST_DATE = LocalDate.parse("2024-09-03");
    private static final ZoneOffset TEST_DATE_OFFSET = TEST_DATE.atStartOfDay(TEST_ZONE).getOffset();
    ...
    private static Stream<Arguments> testDateArguments() {
        return Stream.of(
                ...
                Arguments.of("DateTime with positive offset",
                        "2024-09-03" + TEST_DATE_OFFSET,
                        OffsetDateTime.parse("2024-09-03T00:00:00" + TEST_DATE_OFFSET)
                ),
                Arguments.of("DateTime with default offset",
                        "2024-09-03",
                        TEST_DATE.atStartOfDay(TEST_ZONE).toOffsetDateTime()
                )
        );
    }
