...
public class Constants {
    ...
    public static final String SIGNED_SERVICE_METADATA_BODY_URN_POLAND_NCPB = "<SignedServiceMetadata xmlns=\"http://docs.oasis-open.org/bdxr/ns/SMP/2016/05\">\n" +
            ...
            "\t\t\t\t\t\t\t<TechnicalContactUrl>http://poland/contact</TechnicalContactUrl>\n" +
            "\t\t\t\t\t\t\t<TechnicalInformationUrl>http://poland/contact</TechnicalInformationUrl>\n" +
            "\t\t\t\t\t\t\t<Extension><Signature xmlns=\"http://www.w3.org/2000/09/xmldsig#\"><SignedInfo><CanonicalizationMethod Algorithm=\"http://www.w3.org/TR/2001/REC-xml-c14n-20010315\"/><SignatureMethod Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><Reference URI=\"\"><Transforms><Transform Algorithm=\"http://www.w3.org/2000/09/xmldsig#enveloped-signature\"/></Transforms><DigestMethod Algorithm=\"http://www.w3.org/2001/04/xmlenc#sha256\"/><DigestValue>ey+nljKuyPHWTXkFBLB7HNdS0hPM9d4t5HTFQT2TlBQ=</DigestValue></Reference></SignedInfo><SignatureValue>KnFuvpIutfkod+dF7KtAv6U7136MWCfqb6Z+LXorgQeA4xSmHP8Ic/V2o+w9ZmF3Ak/ImXVb3v24\n" +
            "JYaYmrCy3q2uEVKZ0IdFnsri5/ykEMUDI9aR3tkefcWKRK/FCb2+0jfqHMq11lii+CBBlwuTvoXE\n" +
            "KmTJj7fZb/0DCUAezmg=</SignatureValue><KeyInfo><X509Data><X509SubjectName>CN=Sample National Infrastructure,OU=Sante,C=PT</X509SubjectName><X509Certificate>MIICAzCCAWygAwIBAgIEWCRzHjANBgkqhkiG9w0BAQsFADBGMQswCQYDVQQGEwJQVDEOMAwGA1UE\n" +
            ...
            "\t\t</ServiceInformation>\n" +
            "\t</ServiceMetadata>\n" +
            "<Signature xmlns=\"http://www.w3.org/2000/09/xmldsig#\"><SignedInfo><CanonicalizationMethod Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/><SignatureMethod Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><Reference URI=\"\"><Transforms><Transform Algorithm=\"http://www.w3.org/2000/09/xmldsig#enveloped-signature\"/></Transforms><DigestMethod Algorithm=\"http://www.w3.org/2001/04/xmlenc#sha256\"/><DigestValue>EchLfvR6YNZUIJJrblCj6dYdfKGe2xvL4Iz3FD6qfn0=</DigestValue></Reference></SignedInfo><SignatureValue>Zhs0P/K7QGOQjV2KUSn4Vq+dwcgRUqFCGKtBQ/vbsV/hNuXBPjq+qOa2cCk2G3OeC/P5bmOV/HQL\n" +
            "1j+Hvuqx6B/0HdnDqBufVOcL9ina1+hdJ7wZzjH7oqaSlwBh7lE9WwSnv8uc4XAcHUUPvc2Dze7W\n" +
            "btQzMht7ePi7YAM+7Y0=</SignatureValue><KeyInfo><X509Data><X509SubjectName>CN=SMP Mock Services,OU=DIGIT,O=European Commision,C=BE</X509SubjectName><X509Certificate>MIICIzCCAYygAwIBAgIEWCRzfjANBgkqhkiG9w0BAQsFADBWMQswCQYDVQQGEwJCRTEbMBkGA1UE\n" +
    ...
    public static final String SIGNED_SERVICE_METADATA_BODY_URN_POLAND_NCPB_INVALID_SIGNATURE = "<SignedServiceMetadata xmlns=\"http://docs.oasis-open.org/bdxr/ns/SMP/2016/05\">\n" +
            "\t<ServiceMetadata>\n" +
            "\t\t<ServiceInformation>\n" +
            "\t\t\t<ParticipantIdentifier scheme=\"ehealth-actorid-qns\">urn:poland:ncpb</ParticipantIdentifier>\n" +
            "\t\t\t<DocumentIdentifier scheme=\"ehealth-resid-qns\">urn::epsos##services:extended:epsos::107</DocumentIdentifier>\n" +
    ...
    public static final String SERVICE_METADATA_BODY_9915_123456789 = "<ServiceMetadata xmlns=\"http://docs.oasis-open.org/bdxr/ns/SMP/2016/05\">" +
            "\t\t<ServiceInformation>\n" +
    ...
    public static final String SIGNED_SERVICE_METADATA_BODY_9915_123456789 = "<SignedServiceMetadata xmlns=\"http://docs.oasis-open.org/bdxr/ns/SMP/2016/05\">\n" +
            ...
            "            <ProcessList>\n" +
            "                <Process>\n" +
            "                    <ProcessIdentifier scheme=\"cenbii-procid-ubl\">urn:www.cenbii.eu:profile:bii05:ver2.0\n" +
            "                    </ProcessIdentifier>\n" +
            "                    <ServiceEndpointList>\n" +
            "                        <Endpoint transportProfile=\"bdxr-transport-ebms3-as4-v1p0\">\n" +
            "                            <EndpointURI>https://test.erechnung.gv.at/as4/msh/</EndpointURI>\n" +
            "                            <RequireBusinessLevelSignature>false</RequireBusinessLevelSignature>\n" +
            "                            <MinimumAuthenticationLevel>\"bdxr-docid:loa:1</MinimumAuthenticationLevel>\n" +
            "                            <ServiceActivationDate>2016-06-06T11:06:02.000+02:00</ServiceActivationDate>\n" +
            "                            <ServiceExpirationDate>2026-06-06T11:06:02+02:00</ServiceExpirationDate>\n" +
            "                            <Certificate>\n" +
            "                                \n" +
            ...
            "                            <TechnicalContactUrl>peppol-support@peppol.at</TechnicalContactUrl>\n" +
            "                            <TechnicalInformationUrl>http://www.peppol.at</TechnicalInformationUrl>\n" +
            "                            <Extension><Signature xmlns=\"http://www.w3.org/2000/09/xmldsig#\"><SignedInfo><CanonicalizationMethod Algorithm=\"http://www.w3.org/TR/2001/REC-xml-c14n-20010315\"/><SignatureMethod Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><Reference URI=\"\"><Transforms><Transform Algorithm=\"http://www.w3.org/2000/09/xmldsig#enveloped-signature\"/></Transforms><DigestMethod Algorithm=\"http://www.w3.org/2001/04/xmlenc#sha256\"/><DigestValue>NFMwPU+JRALIFY17oQGLhxIx7BvxIKfcEXDSlrLDNPE=</DigestValue></Reference></SignedInfo><SignatureValue>VlR6eyBBy8cOBywpFXhZ7m3bDAfs9lje3f6yXJF2+aJzs9e8mEEmynaNrNNzOkUUjsJ+IUCdWZgK\n" +
            "ZTwOs1R0evypzDkHahw4EFl6jrU67XoVtb1/cIpYAEyJXR3rTeUBsyP8q94JJy3JvZyhoNSKqiR5\n" +
            "cqkM9d+V+NX4BmE5Ikg=</SignatureValue><KeyInfo><X509Data><X509SubjectName>CN=Sample National Infrastructure,OU=Sante,C=PT</X509SubjectName><X509Certificate>MIICAzCCAWygAwIBAgIEWCRzHjANBgkqhkiG9w0BAQsFADBGMQswCQYDVQQGEwJQVDEOMAwGA1UE\n" +
            "CwwFU2FudGUxJzAlBgNVBAMMHlNhbXBsZSBOYXRpb25hbCBJbmZyYXN0cnVjdHVyZTAeFw0xNjEx\n" +
            "MTAxMzE2NTBaFw0yNjExMTAxMzE2NTBaMEYxCzAJBgNVBAYTAlBUMQ4wDAYDVQQLDAVTYW50ZTEn\n" +
            "MCUGA1UEAwweU2FtcGxlIE5hdGlvbmFsIEluZnJhc3RydWN0dXJlMIGfMA0GCSqGSIb3DQEBAQUA\n" +
            "A4GNADCBiQKBgQCywt50WXEWIiWytRGcMqzeMM/EyxruNthPdiUEUTbs9un7lzGGjpfFMTgd83wJ\n" +
            ...
            "        </ServiceInformation>\n" +
            "    </ServiceMetadata>\n" +
            "<Signature xmlns=\"http://www.w3.org/2000/09/xmldsig#\"><SignedInfo><CanonicalizationMethod Algorithm=\"http://www.w3.org/2001/10/xml-exc-c14n#\"/><SignatureMethod Algorithm=\"http://www.w3.org/2000/09/xmldsig#rsa-sha1\"/><Reference URI=\"\"><Transforms><Transform Algorithm=\"http://www.w3.org/2000/09/xmldsig#enveloped-signature\"/></Transforms><DigestMethod Algorithm=\"http://www.w3.org/2001/04/xmlenc#sha256\"/><DigestValue>p5XE3Ef1C7eLzkcAb33y2ZVuxZv0N8db1yBtH7vGnu8=</DigestValue></Reference></SignedInfo><SignatureValue>jLVsLJBs/MUzqEdFJcTDXOY8ShR6XAzRj87TDOZg68GhQ+lQbOeZ2IYfKo+/xAGI9JVQgTcgfKGI\n" +
            "S5u7a92su9fpYpaADHvCxDIcUJRCdPhuQ2gINYpDrnQTU/xargUv4Pt9kXLwBOhEbum5ZtOX8PJp\n" +
            "XUWfLecJn0r5ulDblzM=</SignatureValue><KeyInfo><X509Data><X509SubjectName>CN=SMP Mock Services,OU=DIGIT,O=European Commision,C=BE</X509SubjectName><X509Certificate>MIICIzCCAYygAwIBAgIEWCRzfjANBgkqhkiG9w0BAQsFADBWMQswCQYDVQQGEwJCRTEbMBkGA1UE\n" +
            "CgwSRXVyb3BlYW4gQ29tbWlzaW9uMQ4wDAYDVQQLDAVESUdJVDEaMBgGA1UEAwwRU01QIE1vY2sg\n" +
            "U2VydmljZXMwHhcNMTYxMTEwMTMxODE4WhcNMjYxMTEwMTMxODE4WjBWMQswCQYDVQQGEwJCRTEb\n" +
            "MBkGA1UECgwSRXVyb3BlYW4gQ29tbWlzaW9uMQ4wDAYDVQQLDAVESUdJVDEaMBgGA1UEAwwRU01Q\n" +
            "IE1vY2sgU2VydmljZXMwgZ8wDQYJKoZIhvcNAQEBBQADgY0AMIGJAoGBALrpN2GGqctPTP27g+zA\n" +
    ...
    public static final String SIGNED_SERVICE_METADATA_BODY_9915_123456789_INVALID_SIGNATURE = "<SignedServiceMetadata xmlns=\"http://docs.oasis-open.org/bdxr/ns/SMP/2016/05\">\n" +
            "    <ServiceMetadata>\n" +
            "        <ServiceInformation>\n" +
            "            <ParticipantIdentifier scheme=\"iso6523-actorid-upis\">9915:123456789</ParticipantIdentifier>\n" +
            "            <DocumentIdentifier scheme=\"bdxr-docid-qns\">urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2::CreditNote##urn:www.cenbii.eu:transaction:biitrns014:ver2.0:extended:urn:www.peppol.eu:bis:peppol5a:ver2.0::2.1</DocumentIdentifier>\n" +
