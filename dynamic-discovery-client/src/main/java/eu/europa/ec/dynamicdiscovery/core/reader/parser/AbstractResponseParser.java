...
public abstract class AbstractResponseParser {
    ...
    protected AbstractSignatureValidator signatureValidator;

    public AbstractResponseParser(JAXBContext jaxbContext, AbstractSignatureValidator signatureValidator) {
        try {
